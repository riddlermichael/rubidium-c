...
install(TARGETS ${LIB} EXPORT RbCTargets INCLUDES DESTINATION "${INSTALL_RBC_HOME}")

install(EXPORT RbCTargets NAMESPACE RbC:: DESTINATION "${CONFIG_DESTINATION}")

install(FILES "${CONFIG_FILE}" "${CONFIG_VERSION_FILE}" DESTINATION "${CONFIG_DESTINATION}")

install(FILES "${VERSION_FILE}" "${FEATURE_FILE}" DESTINATION "${INSTALL_RBC_HOME}/rb")
...
foreach(HEADER ${HEADERS})
    ...
    install(FILES ${HEADER} DESTINATION "${INSTALL_RBC_HOME}/${HEADER_DIRECTORY_PATH}")
endforeach()
