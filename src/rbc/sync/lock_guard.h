...
#define RBC_LOCK_GUARD_DEF(type_name, lockable_t, export)                                     \
	...
	RBC_BEGIN_EXTERN_C                                                                        \
                                                                                              \
	export RbcError RBC_METHOD(type_name, init)(type_name * self)                             \
	    RBC_NONNULL RBC_ACQUIRE_CAPABILITY(self->lockable);                                   \
	export RbcError RBC_METHOD(type_name, init_with)(type_name * self, lockable_t * lockable) \
	    RBC_NONNULL RBC_ACQUIRE_CAPABILITY(self->lockable);                                   \
	export RbcError RBC_METHOD(type_name, destroy)(type_name * self)                          \
	    RBC_NONNULL RBC_RELEASE_CAPABILITY(self->lockable);                                   \
                                                                                              \
	RBC_END_EXTERN_C

#define RBC_LOCK_GUARD_IMPL(type_name, lockable_t)                                     \
	RbcError RBC_METHOD(type_name, init)(type_name * self)                             \
	    RBC_NO_THREAD_SAFETY_ANALYSIS {                                                \
		return RBC_CONCAT(lockable_t, _lock)(*self->lockable);                         \
	}                                                                                  \
                                                                                       \
	RbcError RBC_METHOD(type_name, init_with)(type_name * self, lockable_t * lockable) \
	    RBC_NO_THREAD_SAFETY_ANALYSIS {                                                \
		self->lockable = lockable;                                                     \
		return RBC_CONCAT(lockable_t, _lock)(*lockable);                               \
	}                                                                                  \
                                                                                       \
	RbcError RBC_METHOD(type_name, destroy)(type_name * self)                          \
	    RBC_NO_THREAD_SAFETY_ANALYSIS {                                                \
