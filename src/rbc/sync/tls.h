...
typedef struct RbcTlsImpl RbcTlsImpl;

struct RbcTls {
	RbcTlsImpl* impl;
};
typedef struct RbcTls RbcTls;

RBC_BEGIN_EXTERN_C

typedef void (*RbcTlsDtor)(void*);
 ...
 */
RBC_EXPORT RbcError rbc_tls_init(RbcTls* self, RbcTlsDtor dtor) RBC_NONNULL_ARGS(1);
 ...
 */
RBC_EXPORT RbcError rbc_tls_destroy(RbcTls* self) RBC_NONNULL;
 ...
 */
RBC_EXPORT RbcError rbc_tls_get(RbcTls self, void** value) RBC_NONNULL;
 ...
 */
RBC_EXPORT RbcError rbc_tls_set(RbcTls self, void const* value) RBC_NONNULL;
